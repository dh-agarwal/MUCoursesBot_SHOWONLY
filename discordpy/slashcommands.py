...
class MenuOneTwoDropAllEnabled(discord.ui.View):
  ...
  @discord.ui.button(emoji="<:leftarrow2:1014632274211385405>", style=discord.ButtonStyle.green)
  ...
  @discord.ui.button(emoji="<:rightarrow2:1014632489005891736>", style=discord.ButtonStyle.green)
...
class MenuOneTwoDropRightDisabled(discord.ui.View):
  ...
  @discord.ui.button(emoji="<:rightarrow2:1014632489005891736>", style=discord.ButtonStyle.green, disabled = True)
  async def rightbut(self,interaction:discord.Interaction, button:discord.ui.Button):
    await interaction.response.defer()
...
class MenuOneTwoDropLeftDisabled(discord.ui.View):
  ...
  @discord.ui.button(emoji="<:leftarrow2:1014632274211385405>", style=discord.ButtonStyle.green, disabled = True)
  async def leftbut(self,interaction:discord.Interaction, button:discord.ui.Button):
    await interaction.response.defer()
...
class ShowMenu(discord.ui.View):
  ...
  async def showmenu(self,interaction:discord.Interaction, button:discord.ui.Button):
    await interaction.response.defer()
    temp = await interaction.followup.send(view=HideMenu(), embed=getMenuEmbed(aclient.hall[interaction.guild.id], interaction, True))
    await aclient.msg[interaction.guild.id].delete()
    aclient.msg[interaction.guild.id] = temp
...
class HideMenu(discord.ui.View):
  ...
  async def showmenu(self,interaction:discord.Interaction, button:discord.ui.Button):
    await interaction.response.defer()
    temp = await interaction.followup.send(view=ShowMenu(), embed=getMenuEmbed(aclient.hall[interaction.guild.id], interaction, False))
    await aclient.msg[interaction.guild.id].delete()
    aclient.msg[interaction.guild.id] = temp
...
class rightButton(Button):
  def __init__(self):
    super().__init__(emoji="<:rightarrow2:1014632489005891736>", style=discord.ButtonStyle.green)
...
class leftButton(Button):
  def __init__(self, disabled):
    super().__init__(emoji="<:leftarrow2:1014632274211385405>", style=discord.ButtonStyle.green, disabled = disabled)
...
async def menu(interaction: discord.Interaction, hall : str):
    ...
    aclient.msg[interaction.guild.id] = await interaction.followup.send(view=ShowMenu(), embed=getMenuEmbed(aclient.hall[interaction.guild.id], interaction, False))
